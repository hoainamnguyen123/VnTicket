...
public interface EventRepository extends JpaRepository<Event, Long> {
    ...
    Page<Event> findByStatus(com.vnticket.entity.EventStatus status, Pageable pageable);

    Page<Event> findByTypeContainingIgnoreCaseAndStatus(String type, com.vnticket.entity.EventStatus status,
            Pageable pageable);
    ...
    Page<Event> searchEventsByStatus(@Param("keyword") String keyword,
            @Param("status") com.vnticket.entity.EventStatus status, Pageable pageable);
