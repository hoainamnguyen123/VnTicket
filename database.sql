-- Tạo database (chạy trong command line hoặc pgAdmin):
-- CREATE DATABASE vnticket;

-- Các bảng sẽ tự động được tạo bởi Hibernate (ddl-auto: update).
-- Dưới đây là script mock data để có sẵn Data test:

-- Mật khẩu cho cả 2 user đều là: 123456
...
('BlackPink World Tour 2026', 'https://kenh14cdn.com/203336854389633024/2023/6/26/photo-5-1687756182583272935275.jpg', 'Concert âm nhạc hoành tráng nhất năm', '2026-12-20 19:30:00', 'Sân Vận Động Mỹ Đình, Hà Nội', 'CONCERT'),
('VietNam vs Thailand - Chung kết AFF Cup', 'https://vff.org.vn/wp-content/uploads/2022/12/320140685_915443206297314_2961817757697410497_n.jpg', 'Trận bóng đá siêu kinh điển Đông Nam Á', '2026-11-15 19:00:00', 'Sân Vận Động Mỹ Đình, Hà Nội', 'FOOTBALL');
